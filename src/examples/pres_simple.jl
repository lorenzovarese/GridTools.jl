...
@field_operator function simple_add(
    a::Field{Tuple{Cell_, K_}, Float64},
    b::Field{Tuple{Cell_, K_}, Float64}
)::Field{Tuple{Cell_, K_}, Float64}
    return a .+ b
end

# Creation of Fields
a = Field((Cell, K), reshape(collect(1.0:6.0), (2, 3)))
b = Field((Cell, K), reshape(collect(2.0:7.0), (2, 3)))
...
offset_provider =
    Dict{String, Union{Connectivity, Dimension}}("E2C" => E2C_offset_provider,)
